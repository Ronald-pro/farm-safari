  ...
  return (
    <section className="bg-white py-12 px-6">
      <div className="max-w-7xl mx-auto space-y-24">
        ...
        >
          <h3 className="text-2xl font-bold text-[#61A534] mb-4">Our Approach</h3>
          ...
          <div className="grid gap-8 md:grid-cols-2">
            {[
              ...
              <div key={idx} className="flex items-start gap-4 p-6 bg-gray-50 rounded-xl shadow-md hover:shadow-lg transition">
                <div className="p-4 bg-[#61A534] rounded-full flex items-center justify-center">
                  {item.icon}
                </div>
                <div>
                  <h4 className="text-xl font-semibold text-[#61A534] mb-1">{item.title}</h4>
        ...
        >
          <h3 className="text-2xl font-bold text-[#61A534] text-center mb-4">Our Strategic Framework</h3>
          <p className="text-gray-600 text-lg mb-12 text-center">
            Farm Safari Advances the United Nations Sustainable Development Goals.
            Farm Safari’s commitment to regenerative agriculture and sustainable land management supports multiple global goals.
            Our approach not only restores degraded farmland but also strengthens communities, improves food security, and creates economic opportunities.
          </p>
            ...
            {[
              ...
              },
              {
                ...
                goals: [
                  ...
                  "Goal: Promote sustainable livelihoods through regenerative agriculture. Regenerative farming creates dignified, sustainable livelihoods. By increasing productivity and market access, Farm Safari enables farmers to earn more, invest in their futures, and contribute to resilient communities."
                ],
              ...
              <div key={idx} className="mb-12 ml-6 pl-6 relative">
                {/* Icon */}
                <span className={`absolute -left-[42px] bg-white p-3 rounded-full shadow ${item.color}`}>
                  {item.icon}
                </span>
                <h3 className="text-xl font-bold text-[#61A534]">{item.title}</h3>
          ...
          {/* PILLARS */}
          <div className="mt-16">
            <h3 className="text-3xl font-semibold text-[#61A534] mb-4 text-center">Our Pillars</h3>
            <p className="text-gray-600 text-lg mb-12 text-center max-w-4xl mx-auto">
              Our strategic framework is built on four pillars to achieve sustainable agriculture and agroforestry in Kenya:
            </p>
            <div className="grid gap-8 md:grid-cols-2">
              {[
                {
                ...
                <div key={idx} className="bg-white rounded-xl shadow-lg p-6 border-t-4 border-green-600 hover:shadow-xl transition duration-300">
                  <div className="flex items-center mb-4 space-x-3">
                    {pillar.icon}
                    <h4 className="text-xl font-bold text-[#61A534]">{pillar.title}</h4>
                  </div>
